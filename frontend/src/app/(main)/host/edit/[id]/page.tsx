...
import EditPropertyWizard from '@/components/features/host/EditPropertyWizard'
...
export default function EditPropertyPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 flex items-center justify-center">
        <div className="text-center bg-white p-8 rounded-3xl shadow-2xl max-w-md mx-4">
          ...
          <h2 className="text-2xl font-bold text-red-600 mb-4">ID Property Không Hợp Lệ</h2>
          <p className="text-gray-600 mb-6">Property ID phải là một số nguyên dương.</p>
          <button
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center relative z-10 backdrop-blur-sm bg-white/80 p-12 rounded-3xl border border-pink-600/20 shadow-2xl max-w-md mx-4">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            {isLoggedIn ? (
              <>
                Chỉ những <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600 font-semibold">Chủ Nhà Huyền Thuật</span> mới có thể chỉnh sửa property...
              </>
            ) : (
              <>
                Hãy <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600 font-semibold">đăng nhập</span> để truy cập trang chỉnh sửa property...
              </>
            )}
          </p>
  ...
  // Authorized - show the edit wizard
  return (
    <div className="min-h-screen bg-gradient-to-r from-pink-600 to-purple-600 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <EditPropertyWizard propertyId={propertyId} />
      </div>
